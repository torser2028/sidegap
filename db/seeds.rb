Commission.create([
  { name: 'I', legislative: true },
  { name: 'II', legislative: true },
  { name: 'III', legislative: true },
  { name: 'IV', legislative: true },
  { name: 'V', legislative: true },
  { name: 'VI', legislative: true },
  { name: 'VII', legislative: true },
  { name: 'I. Plan de Desarrollo y Ordenamiento Territorial', council: true },
  { name: 'II. Gobierno', council: true },
  { name: 'III. Hacienda y Crédito Público', council: true },
  ])
Source.create([
  { name: 'Cámara'},
  { name: 'Senado'}
...
Topic.create([
  { name: 'Salud', legislative: true, council: true },
  { name: 'Medio Ambiente', legislative: true, council: true },
  { name: 'Laboral y Pensional', legislative: true, council: true },
  { name: 'Administración Pública y Estructura del Estado', legislative: true, council: true },
  { name: 'Infraestructura, Transporte y Movilidad', legislative: true, council: true },
  { name: 'Justicia, Política Criminal y Penitenciaria', legislative: true },
  { name: 'Justicia', council: true },
  { name: 'Honores, Conmemoraciones y Asuntos Culturales', legislative: true, council: true },
  { name: 'Actividad Financiera', legislative: true },
  { name: 'Estampillas', legislative: true },
  { name: 'Educación y Deporte', legislative: true },
  { name: 'Educación', council: true },
  { name: 'Cultura, Recreación y Deporte', council: true },
  { name: 'Seguridad y Defensa', legislative: true, council: true },
  { name: 'Agropecuario', legislative: true, council: true },
  { name: 'Familia y Género', legislative: true, council: true },
  { name: 'Servicios Públicos', legislative: true, council: true },
  { name: 'Impuestos y Condiciones de Inversión', legislative: true, council: true },
  { name: 'Tecnologias de la Información y las Comunicaciones', legislative: true, council: true },
  { name: 'Vivienda', legislative: true, council: true },
  { name: 'Relaciones Internacionales', legislative: true, council: true },
  { name: 'Hidrocarburos, Minería y Energía', legislative: true },
  { name: 'Derechos Fundamentales y Derechos Humanos', legislative: true },
  { name: 'Participación y Democracia', council: true },
  { name: 'Planeación Urbana y Espacio Público', council: true },
  { name: 'Prevención y Atención de Desastres', council: true },
  ])
...
Status.create([
  ...
  { name: '3era Ponencia' , legislative: true },
  { name: '3er Debate' , legislative: true },
  { name: '4ta Ponencia' , legislative: true },
  { name: '4to Debate' , legislative: true },
  { name: '5ta Ponencia' , legislative: true },
  { name: '5to Debate' , legislative: true },
  { name: '6ta Ponencia' , legislative: true },
  { name: '6to Debate' , legislative: true },
  { name: '7ma Ponencia' , legislative: true },
  { name: '7mo Debate' , legislative: true },
  { name: '8va Ponencia' , legislative: true },
  { name: '8vo Debate' , legislative: true },
  { name: 'Pendiente Conciliación' , legislative: true },
  { name: 'Ponencia de Comisiones Conjuntas' , legislative: true },
